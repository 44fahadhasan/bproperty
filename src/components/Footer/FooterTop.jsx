  ...
  return (
    <Containter>
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div>
          <h4 class="text-[#000] uppercase text-sm mb-6">About</h4>
          <ul class="space-y-3">
            {/* menu */}
            {footerMenu?.map((item) => (
              <li>
                <Link
                  to={item?.link}
                  class="hover:text-[#006169] text-[#4a4a4a] text-sm transition-all"
                >
                  {item?.label}
                </Link>
              </li>
        ...
        <div>
          <ul class="flex items-center flex-wrap gap-y-3 space-x-6">
            <li>
              <Link to="">
                <svg
